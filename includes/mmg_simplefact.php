...
?>
  ...
  <input type="text" id="mmgFactHeadline" name="fact_headline" class="fact" maxlength="100" value="" /><br />
  <label for="fact_summary">Fact summary</label>
  <textarea name="fact_summary" id="mmgFactSummary" rows="5">
Find an interesting fact to share about this object.
</textarea>
  <label for="fact_source">Source</label>
  <input type="text" id="mmgFactSource" name="fact_source" class="fact" maxlength="300" value="" />
